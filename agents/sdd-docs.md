...
**well formed**? Each one needs: a bold title + where (`file:line`) + why it matters + found by
(agent/mission/date), and it sits in the section under `<!-- sdd:open -->`. Complete the

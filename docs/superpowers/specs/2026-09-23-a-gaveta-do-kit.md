...
|---|---|---|---|---|
| F1 | Custo do catálogo de mutação | PR #59 mergeado (`d0ac22d`); P2(a) feito em 2026-09-25 (assassino primeiro, amostra 389 → 171 s); P1, P2(b), P3, P4 abertos | P3 (varrer probes sensíveis a tempo sob carga); P2(b) se o carimbo seguir caro | — |
...
- **P2. Catálogo mais barato por estrutura**, a maior alavanca que resta sem trocar linguagem.
  - **(a) Mutante → sensor alvo. FEITO em 2026-09-25**, derivado dos logs e não dos comentários
    ...
    **4 828 → 1 959 s**, 0 de 40 vereditos diferentes. A 1ª rodada depois do merge aprende o mapa
    e custa como antes. O texto original do plano: cada mutante roda primeiro o sensor que o comentário dele

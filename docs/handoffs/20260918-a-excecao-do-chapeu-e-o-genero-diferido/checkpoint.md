...
|---|---|---|---|---|
| I0 | A missão existe para o kit: diretório, branch, ADR 0009 alocado por `sdd adr new` | `./bin/sdd adr check --mission 20260918-a-excecao-do-chapeu-e-o-genero-diferido; echo rc=$?` → `rc=0` | pending | — |

...
| I8 | re-ancorar os itens do TODO.md que apontam o bin/sdd (conteúdo velho junto) | `o=$(bash tests/check-todo.sh --anchors TODO.md bin/sdd 2>&1); grep -c '^  ok    anchors: [1-9][0-9]* measured, 0 off target' <<< "$o"` → `1` | done | f43788f |

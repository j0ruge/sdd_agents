...
quando é ele quem recebe o comando humano (`--phase`, `retry`, `--budget-override`). O humano
que precisa vigiar um `tail -F` para saber que a linha parou não tem hook — tem vigília.
